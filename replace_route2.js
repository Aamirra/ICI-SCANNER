...
const startMarker = "if (req.method === 'GET' && safePath === '/api/crypto-chart')";
const startIdx = content.indexOf(startMarker);
if (startIdx === -1) {
    console.error('❌ Old route not found.');
    process.exit(1);
}
...
console.log('✅ Route replaced with async wrapper successfully.');
