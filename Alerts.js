    ...
    <div class="al-overlay" id="alertOverlay" onclick="closeAlertDialog()">\
      <div class="al-sheet" onclick="event.stopPropagation()">\
        ...
        <div class="al-sheet-header">\
          ...
          <button class="al-close-btn" onclick="closeAlertDialog()">X</button>\
        </div>\
        <div class="al-sheet-body">\
          ...
          <div class="al-sec">\
            ...
            <div class="al-chip-row" id="alNotifyChips">\
              ...
              <div class="al-chip" data-val="popup" onclick="this.classList.toggle(\'active\')">Popup</div>\
    ...
    <div class="al-overlay" id="alListOverlay" onclick="closeAlertsList()">\
      <div class="al-sheet" onclick="event.stopPropagation()">\
        ...
        <div class="al-sheet-header">\
          ...
          <button class="al-close-btn" onclick="closeAlertsList()">X</button>\
        </div>\
...
function alSaveAlerts(arr) {
    ...
    try { if (window.Android) { arr.forEach(alert => window.Android.saveAlert(JSON.stringify(alert))); } } catch(e) {}
}
...
function _alRenderList() {
    ...
    if (!alerts.length) {
        el.innerHTML = '<div class="al-empty"><div style="font-size:36px;margin-bottom:8px">&#128277;</div><div>No alerts set</div><div style="font-size:12px;margin-top:4px;color:#333">Tap the bell icon on any pair</div></div>';
        return;
    }
